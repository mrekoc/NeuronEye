...
def main():
    ...
    for (file, img, thresh, final, value, total, score, recall, precision) in save:
        print("Filename: %s, Detected objects: %d, Actual value: %d, Score: %5.3f, %5.3f, %5.3f" % (file, total, value, score, recall, precision))
    
    print("\n ######## \n ######## \n Average success in this batch: %5.3f \n Average precision : %5.3f \n Average recall : %5.3f" % (rate, rate_p, rate_r))
